...
function Main() {
    return (
        <div id='main'>
            ...
            <p id='starp'>Star Us on GitHub   <a href='https://github.com/oslabs-beta/ChaosQoaLa'target='blank'><button id='gitbutton'><img className='star'src='https://cqlimage.s3-us-west-1.amazonaws.com/star.png'/>Star</button></a></p> 
